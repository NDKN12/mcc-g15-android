...
class MetaKeyDialog extends Dialog implements ConnectionSettable {
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		_canvasActivity.getMenuInflater().inflate(fi.aalto.openoranges.project1.mcc.R.menu.metakeymenu, menu);
		menu.findItem(fi.aalto.openoranges.project1.mcc.R.id.itemDeleteKeyList).setOnMenuItemClickListener(
		...
		menu.findItem(fi.aalto.openoranges.project1.mcc.R.id.itemDeleteKey).setOnMenuItemClickListener(
				new MenuItem.OnMenuItemClickListener() {
	...
	public boolean onPrepareOptionsMenu(Menu menu) {
		menu.findItem(fi.aalto.openoranges.project1.mcc.R.id.itemDeleteKeyList).setEnabled(_currentKeyBean.getMetaListId()>1);
		menu.findItem(fi.aalto.openoranges.project1.mcc.R.id.itemDeleteKey).setEnabled(_spinnerKeysInList.getSelectedItemPosition()!=Spinner.INVALID_POSITION);
		return true;
	}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(fi.aalto.openoranges.project1.mcc.R.layout.metakey);
		setTitle(fi.aalto.openoranges.project1.mcc.R.string.meta_key_title);
		_checkShift = (CheckBox)findViewById(fi.aalto.openoranges.project1.mcc.R.id.checkboxShift);
		_checkCtrl = (CheckBox)findViewById(fi.aalto.openoranges.project1.mcc.R.id.checkboxCtrl);
		_checkAlt = (CheckBox)findViewById(fi.aalto.openoranges.project1.mcc.R.id.checkboxAlt);
		_textKeyDesc = (TextView)findViewById(fi.aalto.openoranges.project1.mcc.R.id.textKeyDesc);
		_textListName = (EditText)findViewById(fi.aalto.openoranges.project1.mcc.R.id.textListName);
		_spinnerKeySelect = (Spinner)findViewById(fi.aalto.openoranges.project1.mcc.R.id.spinnerKeySelect);
		_spinnerKeysInList = (Spinner)findViewById(fi.aalto.openoranges.project1.mcc.R.id.spinnerKeysInList);
		_spinnerLists = (Spinner)findViewById(fi.aalto.openoranges.project1.mcc.R.id.spinnerLists);
		...
		((Button)findViewById(fi.aalto.openoranges.project1.mcc.R.id.buttonSend)).setOnClickListener(new View.OnClickListener() {
		...
		((Button)findViewById(fi.aalto.openoranges.project1.mcc.R.id.buttonNewList)).setOnClickListener(new View.OnClickListener() {
		...
		((Button)findViewById(fi.aalto.openoranges.project1.mcc.R.id.buttonCopyList)).setOnClickListener(new View.OnClickListener() {
